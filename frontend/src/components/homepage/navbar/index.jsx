  ...
  return (
    <div className="navbar-container">
      ...
      <div className="nav-button-container">
        <ul className="nav-button-wrapper">
      ...
      <div className="other-nav-controls">
        <ul className="other-nav-wrapper">
          <li className="other-nav-element">
      ...
      <div className="user-playlists-view">
        <ul>
          {user.playlists.map((playlist) => {
            return (
              <li>
                <Link to={`/${user.id}/playlists/${playlist.id}`}>
