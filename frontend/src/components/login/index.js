...
export default function Login() {
  return (
    <div id="login_container_div">
      <div id="login_spotify_icon_container">
        <svg
          role="img"
          viewBox="0 0 78 24"
          aria-label="Psotify"
      ...
      <div id="login_main_container">
        <div id="login_main_container_form_container">
          <form id="login_main_container_form">
            <div>
            ...
            <div id="login_main_container_form_login_button_div">
              <button>LOG IN</button>
            </div>
          </form>
        </div>
        <div id="login_main_container_footer_container">
          <div id="login_main_container_footer_container_signup_text">
