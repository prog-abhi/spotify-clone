...
export default function Signup() {
  return (
    <div id="signup_container">
      <div id="signup_spotify_icon_container">
        <svg
          role="img"
          viewBox="0 0 78 24"
          aria-label="Psotify"
        ...
        <form>
          ...
          <div>
            ...
            <div className="signup_form_field_container">
              ...
              <input placeholder="Enter your email again"></input>
            </div>
            <div className="signup_form_field_container">
            ...
            <div className="signup_form_field_container">
              ...
              <input placeholder="Create a username."></input>
              <div>
            ...
            <div id="signup_form_consent_checkbox">
            ...
            <div id="signup_form_submit_button">
              <button>Sign up</button>
            </div>
            <div id="signup_form_login_link_span">
              <span>
